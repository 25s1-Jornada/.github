...
[Aqui tem o link do repositorio da NoWaste](https://github.com/25s1-Jornada/NoWaste)
## 🛒FAST:
...
| NoWaste | Alisson Oliveira | Front-End |
| NoWaste | Gabriel Gonçalves | Front-End |
| NoWaste | Pedro Frasson | Front-End |
| NoWaste | Felipe_Bueno | Front-End |
| NoWaste | Vinícius de Morais Boim dos Santos | Bin-Pack |
| NoWaste | Huan Radov Luchetti | Bin-Pack |
| NoWaste | Angelo Avelino | Bin-Pack |
| FAST | Nicolas Lopes Ferracioli | Gestão |
| FAST | Felipe Henrique Augustinho Palhares | Gestão |
| FAST | Leonardo Velani | Gestão | Gestão |
